...
class RadialProgress extends StatefulWidget {
  ...
  const RadialProgress(
      {super.key, required this.activity, required this.number, required this.goalCompleted});
      ...
      child: Container(
        ...
        child: AnimatedOpacity(
          ...
          child: Column(
            children: [
              Text(
                widget.activity.toUpperCase(),
                style: TextStyle(
                    fontSize: 24.0, letterSpacing: 1.5, color: Colors.black),
              ),
              SizedBox(
                height: 4.0,
              ),
  ...
  void paint(Canvas canvas, Size size) {
    ...
    Paint progressPaint = Paint()
      ..shader = LinearGradient(
              colors: [Colors.red, KileleBrown, Colors.orange])
